...
dbms_output.Put_line('AFTER LOGGING IN AS A SELLER OR BUYER, EXECUTE EITHER OF SELLER_ACTIONS OR BUYER_ACTIONS TO SEE THE LIST OF AVAILABLE ACTIONS');
EXCEPTION
  WHEN OTHERS THEN
...
exec user_login('shar@yahoo.com','nmbvc');
...
BEGIN
    ...
    ELSE  
      ...
      dbms_output.Put_line('Customer Subscription updated');
