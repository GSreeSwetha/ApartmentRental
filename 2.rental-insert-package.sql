...
PROCEDURE INSERT_CONCERNS(date_added in DATE,date_resolved in DATE,listing_id in int,complaint in varchar2,query in varchar2,addressed_by in int,solution in varchar2,user_id in int);
...
BEGIN
		DBMS_OUTPUT.PUT_LINE('-------------------------------------------------------------------------------------------------------------------');
		INSERT INTO CONCERNS(date_added ,date_resolved ,listing_id ,complaint, query,addressed_by ,solution,user_id ) VALUES(date_added ,date_resolved ,listing_id ,complaint, query ,addressed_by , solution,user_id );
